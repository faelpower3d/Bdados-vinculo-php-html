...
$result= "UPDATE medico SET nome='$nome', cpf='$cpf', endereco='$endereco', numero='$numero',"; 
$result.=" cidade='$cidade', estado='$estado', cod_esp='$cod_esp' WHERE id_medico='$id_medico'";
