...
$id_medico =filter_input (INPUT_GET, 'id medico', FILTER_SANITIZE_NUMBER_INT); 
$result = "SELECT * FROM medico WHERE id medico = '$id_medico'";  
...
$query= "SELECT from especialidade WHERE id= $cod esp;";
 
$resu= mysqli_query($con, $query) or die (mysqli_connect_error()); $reg mysqli fetch_assoc($resu);
...
$resu2 mysqli_query($con, $query2) or die(mysqli_connect_error()); while ($reg2= mysqli_fetch_array($resu2)) {
